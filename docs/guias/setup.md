...
- [Arquitetura do sistema](../sistema/architecture.md)
- [Testar a API](../sistema/api.md)
- [Conectar ESP32](../sistema/hardware-esp32.md)
- [Reduzir tamanho do clone](./repositorio.md)
- [Visão integradora (engenharias)](../engenharias/README.md)
